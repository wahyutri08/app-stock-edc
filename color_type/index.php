                        ...
                        <div class="col">
                            <div class="card card-outline card-danger">
                                <div class="card-header text-left">
                                    <a href="add_color_name.php" class="btn btn-sm bg-gradient-danger mr-2">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                <li><a class="dropdown-item" href="edit_color.php?id_color=<?= $row["id_color"]; ?>"><i class="fas fa-edit"></i> Edit</a></li>
                                                                <li><a class="dropdown-item tombol-hapus" href="delete_color.php?id_color=<?= $row["id_color"]; ?>"><i class="far fa-trash-alt"></i> Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
