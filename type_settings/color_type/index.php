...
$color_type = query("SELECT * FROM color_type");
                        ...
                        <div class="col">
                            <div class="card card-outline card-danger">
                                <div class="card-header text-left">
                                    <a href="<?= base_url('type_settings/color_type/add_color_name') ?>" class="btn btn-sm bg-gradient-danger mr-2">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                <li><a class="dropdown-item" href="<?= base_url('type_settings/color_type/edit/' . $row['id_color']) ?>"><i class="fas fa-edit"></i> Edit</a></li>
                                                                <li><a class="dropdown-item tombol-hapus" href="<?= base_url('type_settings/color_type/delete/' . $row['id_color']) ?>"><i class="far fa-trash-alt"></i> Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
