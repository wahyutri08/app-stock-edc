...
$query = mysqli_query($db, "SELECT MAX(id_color) AS max_id FROM color_type");
                                ...
                                <form method="POST" action="" id="quickForm">
                                    <div class="card-body">
                                        <div class="form-group col-md-5">
                                            <label for="id_color">ID Color Type:</label>
                                            <input type="number" name="id_color" class="form-control" id="id_color" placeholder="ID Product Name" value="<?= $next_id ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-5">
                                            <label for="name_color">Color Name:</label>
                                            <input type="text" name="name_color" class="form-control" id="name_color" placeholder="Color Name">
                                        </div>
                                        <div class="form-group col-md-5">
                                            <label>Status:</label>
                    ...
                    success: function(response) {
                        ...
                        if (res.status === 'success') {
                            Swal.fire({
                                ...
                                window.location.href = '<?= base_url('type_settings/color_type') ?>';
                            });
                        } else {
